                                            ...
                                            <td class="product-quantity" data-title="Quantity">
                                                <div class="quantity">
                                                    <input type="number" step="1" min="0" max=""
                                                        name="cart[7cbbc409ec990f19c78c75bd1e06f215][qty]" value="2"
                                            ...
                                            <td colspan="6" class="actions">
                                                ...
                                                <div class="coupon">
                                                    ...
                                                    <label for="coupon_code">Coupon:</label> <input type="text"
                                                        ...
                                                        placeholder="Coupon code"> <input type="submit" class="button"
                                                ...
                                                <input type="hidden" id="_wpnonce" name="_wpnonce"
                                                    value="a3d497a332"><input type="hidden" name="_wp_http_referer"
                                                    value="/factory/cart/">
                                            </td>
                                        </tr>
    ...
    <div class="container">
        <div class="col-md-3 col-sm-6 footermin">
            <div class="footermin1">
                <h2>ABOUT US</h2>
                <p>Aenean ut libero vitae sapien ullamcorper semper sed quis turpis. Donec congue felis sed dignissim
                    porttitor.
